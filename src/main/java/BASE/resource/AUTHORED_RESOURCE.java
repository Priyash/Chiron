...
public abstract class AUTHORED_RESOURCE {
    ...
    private void validate(){
        if(uid == null){
            ...
            throw new IllegalArgumentException("Terminology code phrase should not appear in the translation map");
        } else if(!this.Description_valid()){
            throw new IllegalArgumentException("Terminology code phrase/code-string shouldn't be in the RESOURCE_DESCRIPTION map .");
        }
    }
